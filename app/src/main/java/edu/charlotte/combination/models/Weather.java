...
public class Weather {
    ...
    public Weather(JSONObject json) throws JSONException {
        ...
        this.temp_min = mainJsonObject.getDouble("temp");
        this.temp_max = mainJsonObject.getDouble("temp");
        this.humidity = mainJsonObject.getDouble("temp");
        ...
        JSONObject cloudJsonObject= json.getJSONObject("clouds");
